...
VALUES
  (19,"MCDonalds","197-1124 Elementum, Rd.","burgers"),
  (11,"Burguer King","850-2661 Interdum. St.","burgers"),
  (12,"Starbucks","Ap #686-5741 Ipsum Rd.","drinks"),
  (18,"Café Costa","505-7922 Sit St.","drinks"),
  (19,"Café Aliança","Ap #333-6320 Vulputate, Road","drinks"),
  (13,"O Gato Pingado","Ap #175-3890 Curabitur Rd.","pizzaria"),
  (14,"Água na Boca","827-2876 Morbi Road","pizzaria"),
  (15,"Delícias na Panela","363-3617 Pellentesque Rd.","sushi"),
  (16,"Fogão a Lenha","663-7670 Proin Avenue","other"),
  (17,"Jogo de panela","728-6809 Purus St.","other");
