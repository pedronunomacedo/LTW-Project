...
VALUES
  ...
  (7,"Água na Boca","827-2876 Morbi Road","pizza"),
  ...
  (11,"Pizzaria O Portuense","Rua da Alegria","pizza"),
  (12,"Sushimania", "Avenida da Senhora da Aparição", "sushi"),
  (13,"Casa Filipe","728-6809 Purus St.","portuguese"),
  (14,"Taberna da Circunvalação","Rua da Circunvalação","portuguese"),
  (15,"Subway","Avenida da Boavista","sandwich"),
  (16,"Jeronimo","Rotunda D. Afonso Henriques","sandwich"),
  (17,"Gelataria Deluxe","Rua de St. Catarina","ice-cream"),
  (18,"Café Gelatto","Rua da Constituição","ice-cream"),
  (19,"Pans","Rua da Boavista","sandwich"),
  (20,"Salão de Chá D. Rosinha", "Rua da Circunvalação","drinks"),
  (21,"Pizza Hut", "Avenida dos Aliados","pizza");
...
VALUES
  ...
  (2, "King's Burger", "burger", "4.50"),
  (2, "Vegan's Burger", "vegetarian", "4.50"),
  (2, "Double Burger", "burger", "4.50"),
  (2, "Royal Burger", "burger", "4.50"),
  (2, "Extra Cheeseburger", "burger", "4.50"),
  (2, "Meat Lover Burguer", "burger", "7.99"),
  (4, "Meat Lover Burguer", "burger", "7.99"),
  (4, "Ham and Bread", "sandwich", "7.99"),
